...
public class ShipMovement : MonoBehaviour
{
    ...
    private float verticalStep = 3.65f;
    ...
    public void AccelerateForward(float byValye = 0f)
    {
        ...
        cameraController.Resize(hVelocity);
    }
    ...
    private void ChangeVerticalPosition(int step)
    {
        ...
        //gameObject.Tween("ShipMovementY", 0, currentPosition * verticalStep, 
        //    inertiaTime * Math.Abs(currentPosition - (transform.position.y / verticalStep)), 
